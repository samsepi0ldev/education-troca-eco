    ...
    <main>
      <header className='bg-white shadow-md flex items-center justify-between h-16 px-20 uppercase z-20'>
        <div className='flex items-center gap-10 text-zinc-700'>
          ...
          <a className='data-[active=true]:text-violet-500 data-[active=true]:font-bold rounded-md hover:bg-zinc-100 px-4 py-2 transition-colors' href='#'>Sobre</a>
          <a className='data-[active=true]:text-violet-500 data-[active=true]:font-bold rounded-md hover:bg-zinc-100 px-4 py-2 transition-colors' href='#'>Webinars</a>
          <a className='data-[active=true]:text-violet-500 data-[active=true]:font-bold rounded-md hover:bg-zinc-100 px-4 py-2 transition-colors' href='#'>Blog</a>
        </div>
